...
public class AllSpecies_182 {
    public static void main(String[] args) throws Exception {
        ...
        job.setMapperClass(AllSpeciesMapper.class);
        job.setCombinerClass(AllSpeciesReducer.class);
        job.setReducerClass(AllSpeciesReducer.class);
